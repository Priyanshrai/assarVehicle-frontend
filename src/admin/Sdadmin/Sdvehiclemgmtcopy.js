...
function Sdvehiclemgmt() {
  ...
  { id: '360', Mid: '209', Varient: 'V8' }
    , { id: '361', Mid: '211', Varient: 'OTHERS' }, { id: '362', Mid: '7', Varient: 'XT' }, { id: '363', Mid: '7', Varient: 'XZ' }
  ];
      ...
      <div id='home-collapse'>
        <div className='row'>
          ...
          <div className='col-lg-9'>
            <center>
              <h1 id='vmd'>Vehicle Management</h1></center>
                ...
                <div className='card card-body'>
                  <form>
                    ...
                    <div className='form-groupone'>
                      ...
                      <input type='text' className='form-control' value={vehicleregistration} onChange={(e) => setVehicleregistration(e.target.value)} placeholder='Vehicle Registration No.' />
                    </div>
                    <div className='form-groupone'>
                      <label className='mgmt' >Manufacturing Year</label>
                      <input type='date' className='form-control' value={Manufactring} onChange={(e) => setManufactring(e.target.value)} placeholder='Enter Manufactring Year' />
                    </div>
                    <div className='form-groupone'>
                      <label className='mgmt'>Engine No.</label>
                      <input type='text' className='form-control' value={Engine} onChange={(e) => setEngine(e.target.value)} placeholder='Enter Engine No.' />
                    </div>
                    <div className='form-groupone'>
                      <label className='mgmt'>Chassis No.</label>
                      <input type='text' className='form-control' value={Chassis} onChange={(e) => setChassis(e.target.value)} placeholder='Enter Chassis No.' />
                    </div>
                    <div className='form-groupone'>
                      <label className='mgmt'>Colour</label>
                      <input type='text' className='form-control' value={Colour} onChange={(e) => setColour(e.target.value)} placeholder='Enter Colour Name' />
                    </div>
                    <div className='col-auto my-1'>
                      <label className='mr-sm-2 mgmt' for='inlineFormCustomSelect'>Choose Category</label>
                      <select className='custom-select mr-sm-2' value={Category1} onChange={(e) => setCategory1(e.target.value)} onClick={(e) => handleSegment(e.target.value)}>
                    ...
                    <div className='col-auto my-1'>
                      <label className='mr-sm-2 mgmt' for='inlineFormCustomSelect'>Choose Segment</label>
                      <select className='custom-select mr-sm-2' value={Segment1} onChange={(e) => setSegment1(e.target.value)}>
                    ...
                    <div className='col-auto my-1'>
                      <label className='mr-sm-2 mgmt' for='inlineFormCustomSelect'>Choose Manufacturer</label>
                      <select className='custom-select mr-sm-2' value={Manufacturername} onChange={(e) => setManufacturerName(e.target.value)} onClick={(e) => handelModel(e.target.value)}>
                    ...
                    <div className='col-auto my-1'>
                      <label className='mr-sm-2 mgmt' for='inlineFormCustomSelect'>Choose Model</label>
                      <select className='custom-select mr-sm-2' value={Model1} onChange={(e) => setModel1(e.target.value)} onClick={(e) => handelVarient(e.target.value)} >
                    ...
                    <div className='col-auto my-1'>
                      <label className='mr-sm-2 mgmt' for='inlineFormCustomSelect'>Choose Varient</label>
                      <select className='custom-select mr-sm-2' value={Varient1} onChange={(e) => setVarient1(e.target.value)} >
                    ...
                    <div className='col-auto my-1'>
                      <label className='mr-sm-2 mgmt' for='inlineFormCustomSelect'>Seating Capacity</label>
                      <select className='custom-select mr-sm-2' value={Seat1} onChange={(e) => setSeat1(e.target.value)} >
                    ...
                    <div className='col-auto my-1'>
                      <label className='mr-sm-2 mgmt' for='inlineFormCustomSelect'>Fuel Type</label>
                      <select className='custom-select mr-sm-2' value={Fuel1} onChange={(e) => setFuel1(e.target.value)}  >
                    ...
                    <div className='form-groupone'>
                      ...
                      <input type='number' className='form-control' value={Running} onChange={(e) => setRunning(e.target.value)} placeholder='Enter Running KM' />
                    </div>
                    <div className='form-groupone'>
                    ...
                    <div className='form-groupone'>
                      ...
                      <input type='file' className='form-control' onChange={handleChange4} />
                    </div>
                    <div className='form-groupone'>
                      <label className='mgmt'  >Date of Assosciation</label>
                      <input type='date' className='form-control' value={Attachmentdate} onChange={(e) => setAttachment(e.target.value)} placeholder='Attachment Date' />
                    </div>
                    <div className='form-groupone'>
                    ...
                    <button id='b5' type='button' onClick={handleSubmit} className='btn btn-primary' >Submit</button>
                  </form>
                </div>
              </div>
              <table id='tableuser' className='table table-bordered'>
                ...
                </tr>
                {
                  vehicleDetails.map((row) => {
                    ...
                    const RC = '/assets/vehicledoc/registration/' + row.registration;
                    ...
                    return (
                      ...
                      <tr>
                        ...
                        <td><img src={I} height="120" width="150" /></td>
                        <td><img src={RC} height="120" width="150" /></td>
                        <td><img src={Per} height="120" width="150" /></td>
                        <td><img src={P} height="120" width="150" /></td>
                        <td><img src={F} height="120" width="150" /></td>

                        <td>
                          {
                            row.status == 0 &&
                            <a style={{ 'color': 'green' }} onClick={() => { manageUserStatus(row._id, 'verify') }} >Listed</a>
                          }
                          {
                            row.status == 1 &&
                            <a style={{ 'color': 'orange' }} onClick={() => { manageUserStatus(row._id, 'block') }} >Blacklisted</a>
                          }
                        </td>
                        <td>
