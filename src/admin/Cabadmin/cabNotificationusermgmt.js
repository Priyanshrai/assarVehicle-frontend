...
function CabNotificationusermgmt() {
...
<div>
    <div id="home-collapse"> 
        <div className='row'>
                ...
                <center>
                <h1 id="vmd">Notification for Users Management</h1></center>
                    <div className='container-parcha'>
                        <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        Add New Notification for Users 
                        </button>
...
export default CabNotificationusermgmt