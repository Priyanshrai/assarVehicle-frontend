      ...
      <div className="login d-flex align-items-center py-2">
        <div className="container">
          ...
          <div className="col-lg-10">
            ...
            <button type="button" className="btn btn-primary"><Link to="/choosetaxi" style={{color: 'white'}}>CITY TAXI</Link></button>
            <button type="button" className="btn btn-primary"><Link to="/outstation" style={{color: 'white'}}>OUT STATION</Link></button>
            <button type="button" className="btn btn-primary"><Link to="/rentals" style={{color:'white'}}>RENTALS</Link></button>
            </div>
            <div className="col-lg-1 bg-light"></div>          
                 ...
                 <div className="row">
                   <div className="col-lg-12 mb-4">
                     ...
                     <div className="btn-group btn-group-lg">
                      ...
                      <div className='col-lg-12'>
                    <label className='mr-sm-2' id='lbl'>Choose Packages from List</label>
                    ...
                    <option value='0'>Choose Packages </option>
                     ...
                     <div className="col-lg-2 bg-light"></div>   
                     <div className="col-lg-8 align-centre">
                     <h5 id='lbl'>Journey</h5> 
                     <div className="btn-group btn-group-lg">
                      <button type="button" className="btn btn-secondary" data-toggle="collapse1" data-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample1">Now</button>
