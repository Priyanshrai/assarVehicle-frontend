...
import './thankyoutaxi.css'
import {Link} from 'react-router-dom'

function Thankyoutaxi() {
  return (
    <div><main id="main">
    {/* ======= Hero Section ======= */}
    <section>
                  ...
                  <div className="col-lg-6">
                    <div className="detail_up">
                      <span>
                        ...
                        <hr style={{background: '#000066',color: '#000066',borderColor: '#000066',height: '2px',borderRadius:'8px'}}/>
                        <img src="assets/img/profile.png" className="img-fluid" alt="" />
                        <hr style={{background: '#000066',color: '#000066',borderColor: '#000066',height: '2px',borderRadius:'8px'}}/>
                      </span>
                      <span className="pt-4 d-block">
                        <h5>Driver Name :- Anshul Sharma</h5>
                        <h6>Car Color - White</h6>
                        <h6>Mobile No.910-xxxx-999</h6>
                      </span>
                    </div>
                  </div>
                  <div className="col-lg-6"> 
