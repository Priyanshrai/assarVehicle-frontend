...
function Corptransportation() {
  return (
    <div>
     ...
     <div className='col-lg-5'>
   <div className="form-group">
   <label id='lbl'>Driver Package</label>
   <div className="btn-group btn-group-lg">
   <button type="button" className="btn btn-secondary">With Driver</button>
   <button type="button" className="btn btn-secondary">Without Driver</button>
   </div>
   </div>
   </div>
   <div className='col-lg-5'>
...
export default Corptransportation ;